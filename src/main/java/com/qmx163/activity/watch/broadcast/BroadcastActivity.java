...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        inputView.setOnSendClickListener(new InputView.SendMsgClickListener() {
            ...
            public void onSendClick(String msg, InputUser user) {
                if (chatFragment != null)
                    chatFragment.performSend(msg, ChatLiveFragment.CHAT_EVENT_CHAT);
            }
        });
        ...
        chatFragment = (ChatLiveFragment) getSupportFragmentManager().findFragmentById(R.id.chatFrame);
        if (chatFragment == null) {
