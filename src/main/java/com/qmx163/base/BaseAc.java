 ...
 */
public class BaseAc extends FragmentActivity implements SwipeBackActivityBase {
    ...
    Unbinder unbinder;
    protected List<BaseAc> mActivityList = new ArrayList<BaseAc>();
...
//        realm.close();
    ...
    public void clearActivity() {
        for (BaseAc baseActivity : mActivityList) {
            baseActivity.finish();
        }
        mActivityList.clear();
    }
