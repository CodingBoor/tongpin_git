 ...
 */
public class BaseAcNoStatusBar extends FragmentActivity implements SwipeBackActivityBase {
    ...
    Unbinder unbinder;
    protected List<BaseAcNoStatusBar> mActivityList = new ArrayList<BaseAcNoStatusBar>();
...
//        realm.close();
    ...
    public void clearActivity() {
        for (BaseAcNoStatusBar baseActivity : mActivityList) {
            baseActivity.finish();
        }
        mActivityList.clear();
    }
