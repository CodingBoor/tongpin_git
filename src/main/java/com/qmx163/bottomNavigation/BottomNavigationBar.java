package com.qmx163.bottomNavigation;
...
import com.qmx163.R;
import com.qmx163.bottomNavigation.behaviour.BottomNavBarFabBehaviour;
import com.qmx163.bottomNavigation.utils.Utils;
 ...
 * @since 19 Mar 2016
 */
@CoordinatorLayout.DefaultBehavior(BottomNavBarFabBehaviour.class)
public class BottomNavigationBar extends FrameLayout {
    ...
    ArrayList<com.qmx163.bottomNavigation.BottomNavigationItem> mBottomNavigationItems = new ArrayList<>();
...
//    }
     ...
     * @return this, to allow builder pattern
     */
    public BottomNavigationBar removeItem(com.qmx163.bottomNavigation.BottomNavigationItem item) {
    ...
    public void initialise() {
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            if (mMode == MODE_FIXED || mMode == MODE_FIXED_NO_TITLE) {
                ...
                for (com.qmx163.bottomNavigation.BottomNavigationItem currentItem : mBottomNavigationItems) {
