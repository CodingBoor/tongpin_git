...
class BottomNavigationHelper {
     ...
     */
    static void bindTabWithData(com.qmx163.bottomNavigation.BottomNavigationItem bottomNavigationItem, BottomNavigationTab bottomNavigationTab, BottomNavigationBar bottomNavigationBar) {
        ...
        if (activeColor != com.qmx163.bottomNavigation.utils.Utils.NO_COLOR) {
            bottomNavigationTab.setActiveColor(activeColor);
        } else {
            bottomNavigationTab.setActiveColor(bottomNavigationBar.getActiveColor());
        }

        if (inActiveColor != com.qmx163.bottomNavigation.utils.Utils.NO_COLOR) {
        ...
        com.qmx163.bottomNavigation.BadgeItem badgeItem = bottomNavigationItem.getBadgeItem();
        if (badgeItem != null) {
