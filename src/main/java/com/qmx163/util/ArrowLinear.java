 ...
 *
 */
public class ArrowLinear extends LinearLayout {
    public ArrowLinear(Context context, AttributeSet attrs) {
        super(context, attrs);
        ini(context, attrs);
    }
    ...
    public ArrowLinear(Context context, AttributeSet attrs, int defStyle) {
    ...
    public ArrowLinear(Context context) {
        super(context);
    }
