...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		final int defaultPageColor = ContextCompat.getColor(context,R.color.pageColor);
		final int defaultFillColor = ContextCompat.getColor(context,R.color.fillColor);
...
//		a.recycle();
	...
	protected void onDraw(Canvas canvas) {
		...
		final int count = mViewPager.getAdapter().getCount()/pagesize;
		if (count == 0) {
			return;
		}
...
//		        }
		...
		final float threeRadius = mRadius * 4;//4：修改两点间的间距
