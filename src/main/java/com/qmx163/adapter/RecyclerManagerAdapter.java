...
/**
 * recyclerview 的Adapter类
 * Created by likai on 2017/7/3.
 */

public abstract class RecyclerManagerAdapter<T> extends BaseRecyclerAdapter<RecyclerViewHolder> {

    protected Context context;

    protected LayoutInflater inflater;

    protected StudyCommentManager listData;
    ...
    public RecyclerManagerAdapter(Context context, StudyCommentManager listData, int itemLayoutId) {
...
//    }
    ...
    public T getItem(int position) {
        return (T) listData.getCommentByIndex(position);
    }
...
//        runEnterAnimation(holder.itemView, position);  //item动画展示
    ...
    public void insert(StudyCommentManager listData, T object, int position) {
        insert(this.listData, object, position);
    }
