...
public class MyZXingActivity_ViewBinding implements Unbinder {
  ...
  public MyZXingActivity_ViewBinding(MyZXingActivity target, View source) {
    ...
    target.mIvHead = Utils.findRequiredViewAsType(source, R.id.iv_head, "field 'mIvHead'", ImageView.class);
    target.mTvName = Utils.findRequiredViewAsType(source, R.id.tv_name, "field 'mTvName'", TextView.class);
    target.mIvZxing = Utils.findRequiredViewAsType(source, R.id.iv_zxing, "field 'mIvZxing'", ImageView.class);
    target.mIvSex = Utils.findRequiredViewAsType(source, R.id.iv_sex, "field 'mIvSex'", ImageView.class);
