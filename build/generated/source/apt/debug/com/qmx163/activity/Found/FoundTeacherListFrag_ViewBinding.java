...
public class FoundTeacherListFrag_ViewBinding implements Unbinder {
  private FoundTeacherListFrag target;

  @UiThread
  public FoundTeacherListFrag_ViewBinding(FoundTeacherListFrag target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FoundTeacherListFrag target = this.target;
